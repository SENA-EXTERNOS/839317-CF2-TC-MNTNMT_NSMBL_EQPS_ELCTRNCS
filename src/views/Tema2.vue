  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span.cblanco 2
      h1 Comprobación del correcto funcionamiento de los circuitos de acuerdo con procedimientos técnicos y normativos
    ...
    .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5(data-aos='flip-right')
      ...
      .bloque-texto-g__texto.p-4
        p.mb-0 Para realizar una comprobación adecuada del funcionamiento de los circuitos electrónicos y eléctricos, se deben tener en cuenta definiciones y leyes presentes en estos dispositivos. A continuación, se muestran de manera detallada, cada una de estas.

    Separador

    
    h3 Variables eléctricas y electrónicas
    ...
    PasosA.color-acento-contenido.mb-5(tipo="n")
      .row.align-items-center.justify-content-center
        .col-md-7.order-sm-last.order-md-first
          h4 Corriente
          p La corriente se define como el flujo de carga eléctrica que pasa por dos puntos de un circuito, en un determinado instante de tiempo. Mileaf, H. (2002), afirma que la corriente se produce, cuando en un conductor hay muchos electrones libres que se mueven en la misma dirección. Dependiendo de su comportamiento en el tiempo, se clasifican en corriente continua o alterna. 
            br
            br
            |La dirección del flujo de carga en un circuito determina la polaridad, la cual puede ser positiva o negativa, en el caso de la corriente alterna esta polaridad cambia con el tiempo. 
            br
            br
            |La corriente continua mantiene una de las dos polaridades fijas.
        .col-md-5(data-aos='fade-left')
          figure
            img(src="@/assets/curso/temas/t2/f2.svg", alt="imagen relacionada")
      .row.align-items-center.justify-content-center
        .col-md-5(data-aos='fade-left')
          figure
      ...
      .row.align-items-center.justify-content-center
        ...
        .col-md-5(data-aos='fade-left')
          figure
            img(src="@/assets/curso/temas/t2/f4.svg", alt="imagen relacionada")
      .row.align-items-center.justify-content-center
        .col-md-5(data-aos='fade-left')
          figure
        ...
        .col-md-7.text-left
          h4 Resistencia
          p La resistencia eléctrica cuantifica el nivel de oposición al flujo de corriente eléctrica que tiene un material o elemento; los materiales de baja conductancia se oponen o resisten al flujo de la corriente eléctrica (Mileaf, H., 2002).
      .row.align-items-center.justify-content-center
        .col-md-7.order-sm-last.order-md-first
          h4 Continuidad
      ...
      .row.align-items-center.justify-content-center
        ...
        .col-md-7.text-left
          ...
          p V = al voltaje o tensión eléctrica.
      .row.align-items-center.justify-content-center
        .col-md-7.order-sm-last.order-md-first
          h4 Ley de Watt
          p La ley de Watt establece la relación que existe entre la potencia consumida, la tensión y la corriente eléctrica de una carga; se define como:
          p P = V  *  I
          p Donde P es la potencia.
        .col-md-5(data-aos='fade-left')
          figure
            img(src="@/assets/curso/temas/t2/f8.svg", alt="imagen relacionada")
      .row.align-items-center.justify-content-center
        .col-md-5(data-aos='fade-left')
          figure
      ...
      .row.align-items-center.justify-content-center
        .col-md-7.order-sm-last.order-md-first
          h4 Diodos
          p Este componente electrónico es un semiconductor que se comporta como un interruptor que se activa mediante unas condiciones específicas y permiten el paso de corriente en una única dirección.
        .col-md-5
          figure
            img(src="@/assets/curso/temas/t2/f10.svg", alt="imagen relacionada")
      .row.align-items-center.justify-content-center
        .col-md-5(data-aos='fade-left')
          figure
      ...
      .row.align-items-center.justify-content-center
        .col-md-7.order-sm-last.order-md-first
          h4 Estática
          p La estática se define como el exceso de carga en movimiento acumulada por un cuerpo u objeto. Cuando este excedente supera el límite de retención del elemento provoca una descarga eléctrica que puede llegar a ocasionar accidentes o averías en los equipos.
        .col-md-5
          figure
    ...
    .bg5
      ...
      .row.justify-content-around.align-items-center.mb-3
        ...
        .col-md-8.tarjeta.fcp20
          .p-4
            h5 Normas técnicas
            p Con el fin de mantener la integridad y la funcionalidad de los equipos se deben caracterizar cada uno de los dispositivos electrónicos para saber qué tipo de requerimientos se deben seguir.
              br
              |La norma de INCONTEC 60601-1 es usada comúnmente en equipos electromédicos para garantizar la seguridad del paciente, del operador y del entorno.
      .row.justify-content-around.align-items-center
        .col-md-7
          h3 Lineamientos de calidad
          p Los lineamientos de calidad son aquellas normas establecidas a nivel internacional que deben seguir cada uno de los diseños electrónicos. Busca garantizar por medio de pruebas que cada uno de los equipos electrónicos cumplan con los requerimientos necesarios en cada una de las normas establecidas. La IEC se encarga de establecer normas internacionales para todas las tecnologías eléctricas, electrónicas y áreas afines.
          p Adicionalmente, cada uno de los países tienen normas que se deben adjuntar en cada una de las pruebas para mantener la seguridad de todos los agentes involucrados en el uso de los equipos. 
        .col-md-5.order-sm-first.order-md-last
          figure
            img(src="@/assets/curso/temas/t2/f19.svg", alt="imagen relacionada")

    Separador

    h3 Protocolo de pruebas

    p.mb-5 Una de las funciones del personal de mantenimiento es la de evitar que las fallas se presenten o se prolonguen por demasiado tiempo, generando gastos operacionales adicionales a los previstos. Por esta razón, se debe realizar un procedimiento adecuado para la localización de la o las fallas existentes en los equipos electrónicos.
    ...
    .tarjeta.tarjeta--gris.p-4.bgslide2.mb-5
      LineaTiempoC.color-acento-contenido
        .row.justify-content-between(titulo="A")
          .col-md-4
            figure
              img(src='@/assets/curso/temas/t2/f20.svg', alt='imagen relacionada')
          .col-md-7.text-white
            h3 Técnica de caza fallas
            p La técnica caza fallas trata de establecer una secuencia lógica de las posibles fallas de un equipo. 
            p Para realizar este procedimiento se busca inspeccionar desde la causa más simple a la más compleja, todo esto en pro de reducir el tiempo de inactividad del equipo. Este procedimiento se conoce como #[em Troubleshooting.]
        .row.justify-content-between(titulo="B")
          .col-md-4
            figure
              img(src='@/assets/curso/temas/t2/f21.svg', alt='imagen relacionada')
          .col-md-7.text-white
            h3 Listado de errores
            p Realizar un listado de cada uno de los errores encontrados o descartados es de suma importancia para evitar la redundancia en las intervenciones y en la focalización de las fallas.
        .row.justify-content-between(titulo="C")
          .col-md-4
            figure
              img(src='@/assets/curso/temas/t2/f22.svg', alt='imagen relacionada')
          .col-md-7.text-white
            h3 Reporte de diagnóstico
            p Una vez finalizadas las pruebas de los equipos, se debe generar un reporte con todos los procedimientos realizados, las fallas encontradas, los elementos reemplazados y una descripción de las observaciones de los técnicos que intervinieron. 
              br
              br
    ...
    .tarjeta.tarjeta--azul.p-4.bgslide1(data-aos='fade-left')
      SlyderA.color-acento-botones(tipo="b")
        ...
        .row.align-items-center.justify-content-between
          .col-md-7.mb-4.mb-md-0
            h4 Riesgo eléctrico
            p El riesgo eléctrico es uno de los accidentes laborales más comunes en la manipulación de equipos electrónicos; se presenta, en ocasiones, como resultado de la estática, pero también es producto del contacto de una extremidad con conductores o conexiones de circuitos electrónicos. Dependiendo de la magnitud y naturaleza de la corriente y voltaje, puede ocasionar lesiones o, inclusive, la muerte. 
              br
              br
              |Se deben señalizar en todo momento, con letreros o con cualquier tipo de advertencia, aquellos componentes propensos a provocar descargas eléctricas para evitar accidentes laborales.
          .col-md-4
            figure
    ...
    .row.justify-content-center.mt-5
      .col-lg-7
        .cajon.color-acento-botones.p-4.mb-4(style="background-color: #fff6e9 ")
